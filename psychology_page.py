...
from data import psychology_image_paths

def psychology_page():
    st.title("Buku-buku Psychology")
    st.write("Berikut ini adalah buku-buku yang tersedia dalam kategori Psychology:")

    images = [Image.open(img_path) for img_path in psychology_image_paths]
