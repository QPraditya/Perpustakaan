...
from data import sejarah_image_paths

import streamlit as st


def sejarah_page():
    st.title("Buku-buku Sejarah")
    st.write("Berikut ini adalah buku-buku yang tersedia dalam kategori Sejarah:")

    images = [Image.open(img_path) for img_path in sejarah_image_paths]
